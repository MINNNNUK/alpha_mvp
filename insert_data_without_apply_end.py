"""
apply_end 컬럼 없이 데이터를 삽입하는 스크립트
"""
...
def insert_data_without_apply_end(supabase: Client, table_name: str):
    """apply_end 컬럼 없이 데이터를 삽입"""
    try:
        # 테이블에 기본 데이터 삽입 시도 (apply_end 제외)
        basic_data = {
            'id': 1,
...
def main():
    ...
    # 기본 데이터 삽입
    insert_data_without_apply_end(supabase, table_name)
