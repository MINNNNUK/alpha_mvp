"""
추천 데이터의 announcement_id를 올바른 공고 ID로 수정
"""
...
def fix_recommendation_announcement_ids():
    """추천 데이터의 announcement_id를 올바른 공고 ID로 수정"""
    print("추천 데이터의 announcement_id 수정 시작...")
    ...
    for company in companies.data:
        ...
        for rank, announcement in enumerate(selected_announcements, 1):
            ...
            recommendation_data = {
                ...
                'announcement_id': announcement['id'],  # 올바른 공고 ID 사용
                'rank': rank,
                'score': round(score, 2),
